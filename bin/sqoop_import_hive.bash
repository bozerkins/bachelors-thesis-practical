...
rm -rf $BACHELORS_PROJECT_DIR/bin/data_io/piwik_visits_hive_tmp

sqoop import \
  --connect jdbc:mysql://localhost:3306/bachelors_piwik  \
  --username root \
  --hive-import \
  --hive-table piwik.piwik_visits \
  --split-by idvisit \
  --as-textfile \
  ...
  --target-dir $BACHELORS_PROJECT_DIR/bin/data_io/piwik_visits_hive_tmp \
